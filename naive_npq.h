 ...
 *
 * @param dataset The processed (subsampled) dataset.
 ...
 */
std::vector<std::pair<std::vector<npq::dim_t>, npq::id_t>> naiveNPQ(const npq::Dataset& dataset, npq::id_t trueNumVectors, double targetDistortion);
